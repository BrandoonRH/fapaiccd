<nav x-data="{ open: false }" class="bg-white p-2 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (!auth()->user()->projects()->exists())
                        <x-nav-link wire:navigate :href="route('proyecto.create')" :active="request()->routeIs('proyecto.create')">
